...
//        Assert.hasText(fieldName, "fieldName");   
    ...
    public static Method getMethod(Object instance, String theMethodName,Class<?>... parameterTypes)   
    throws SecurityException, NoSuchMethodException,   
    IllegalArgumentException, IllegalAccessException,   
    InvocationTargetException {   


       Method method = instance.getClass().getMethod(theMethodName,parameterTypes); 
       return method;
}   
    public static void invokeSetMethod(Object instance, String fieldName, Object fieldValue) throws Exception{
    	Field field = getDeclaredField(instance.getClass(), fieldName); 
    	invokeSetMethod(instance,field,fieldValue);
    }
    /**
     * 调用对象的get方法   
     * @param instance
    ...
    public static Object invokeGetMethod(Object instance, String fieldName) throws Exception{
    	Field field = getDeclaredField(instance.getClass(), fieldName); 
    	return invokeGetMethod(instance,field);
    }
    ...
    */ 
	...
	public static Annotation getFieldAnnotation(Class<?> clazz,String fieldName,String annotationName){
		Field field = getDeclaredField(clazz, fieldName);
		Annotation[] annotations = field.getAnnotations();
		for (Annotation annotation : annotations){
			if (annotationName.equals(annotation.annotationType().getName())) return annotation;
		}
		return null;
	}
	/**
	...
	public static String covert2Str(Object obj,String formatter){
		if(obj==null)return "";
		if(formatter==null){
			if(obj instanceof Date){
				return sdfShort.format((Date)obj);
			}
			if(obj instanceof Timestamp){
				return sdfLong.format((Timestamp)obj);
			}
