		...
		pageSize:20,url:query_url ">
			<thead>
				<tr>
					...
					<th data-options="field:'lessonName',align:'center',width:220">课程</th>
					<th data-options="field:'stuName',align:'center',width:100">学生</th>
					<th data-options="field:'stuScoresRank',align:'center',width:100">排名</th>
				</tr>
			</thead>
	</table>
</body>
