...
<script type="text/javascript">
	var query_url="/answerCorrect.do";
	$(function(){
...
<body>
	...
	<table id="data" class="easyui-datagrid" 
		...
		pageSize:20,url:query_url,nowrap:false ">
			<thead>
				<tr>
					<th data-options="field:'className',align:'center',width:100" rowspan="2">班级</th>
					<th data-options="field:'techNameUse',align:'center',width:100" rowspan="2">老师</th>
					<th data-options="field:'lessonName',align:'center',width:260" rowspan="2">课程</th>
					<th data-options="field:'stuName',align:'center',width:100" rowspan="2">学生</th>
					<th data-options="field:'quesSum',align:'center',width:100" rowspan="2">题目数</th>
					<th colspan="2">完成数</th>
					<th data-options="field:'quesCompRate',align:'center',width:100" rowspan="2">正确率</th>
				</tr>
				<tr>
					<th data-options="field:'quesCompRight',align:'center',width:100">正确</th>
					<th data-options="field:'quesCompError',align:'center',width:100">错误</th>
				</tr>
			</thead>
	</table>
</body>
